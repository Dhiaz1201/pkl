					...
					<ul class="nav metismenu">
						...
						<li class="nav-dropdown active">
							...
							<ul class="collapse in nav-sub" aria-expanded="true">
								<li class="active"><a href="index-2.html"><span>Default</span></a></li>
							...
							<div class="row">
								...
								<div class="col">
									<figure class="tint">
										...
										<img src="/backend/assets/img/demos/ecom-header.jpg" alt="">
									</figure>
								</div>
							</div>
						</div>
									...
									<div class="tab-content" id="pills-tabContent-sales">
										<div class="tab-pane fade show active" id="sales-month-tab" role="tabpanel" aria-labelledby="sales-month-tab">
											<table class="table v-align-middle">
												...
												<tbody>
													<tr>
														<td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle" src="/backend/assets/img/avatars/27.jpg" alt="">
													...
													<tr>
														<td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle" src="/backend/assets/img/avatars/47.jpg" alt="">
															<strong class="nowrap">Shawna Cohen</strong></td>
															<td>$27,600</td>
															<td><span class="badge badge-pill badge-info">Met</span></td>
														</tr>
														<tr>
															<td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle" src="/backend/assets/img/avatars/24.jpg" alt="">
															...
															<tr>
																<td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle" src="/backend/assets/img/avatars/01.jpg" alt="">
																...
																<tr>
																	<td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle" src="/backend/assets/img/avatars/09.jpg" alt="">
																		<strong class="nowrap">Josh Lynch</strong></td>
																		<td>$18,500</td>
																		<td><span class="badge badge-pill badge-warning">Pending</span></td>
																	</tr>
																	<tr>
																		<td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle" src="/backend/assets/img/avatars/26.jpg" alt="">
																			<strong class="nowrap">Jason Kendall</strong></td>
																			<td>$16,300</td>
																			<td><span class="badge badge-pill badge-warning">Pending</span></td>
																		</tr>
																		<tr>
																			<td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle" src="/backend/assets/img/avatars/11.jpg" alt="">
																				<strong class="nowrap">Aaron	Elliott</strong></td>
																				<td>$8,300</td>
																				<td><span class="badge badge-pill badge-danger">Danger</span></td>
																			</tr>
																			<tr>
																				<td class="border-none"><img class="align-self-center mr-3 ml-2 w-50 rounded-circle" src="/backend/assets/img/avatars/21.jpg" alt="">
																	...
																	<div class="tab-pane fade" id="sales-year-tab" role="tabpanel" aria-labelledby="sales-year-tab">
																		<table class="table v-align-middle">
																			...
																			<tbody>
																				<tr>
																					<td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle" src="/backend/assets/img/avatars/02.jpg" alt="">
																				...
																				<tr>
																					<td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle" src="/backend/assets/img/avatars/6.jpg" alt="">
																						<strong class="nowrap">Leslie	Chapman</strong></td>
																						<td>$427,600</td>
																						<td><span class="badge badge-pill badge-success">Above</span></td>
																					</tr>
																					<tr>
																						<td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle" src="/backend/assets/img/avatars/7.jpg" alt="">
																						...
																						<tr>
																							<td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle" src="/backend/assets/img/avatars/35.jpg" alt="">
																							...
																							<tr>
																								<td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle" src="/backend/assets/img/avatars/38.jpg" alt="">
																									<strong class="nowrap">Josh Lynch</strong></td>
																									<td>$293,500</td>
																									<td><span class="badge badge-pill badge-warning">Pending</span></td>
																								</tr>
																								...
																								<tr>
																									<td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle" src="/backend/assets/img/avatars/30.jpg" alt="">
